#Explota el paralelismo con la libreria Process y utiliza
#como mecanismo para compartir datos una cola (Queue)
#Cada proceso crea su propia lista de numeros aleatorios,
#realiza la suma acumulativa de los elementos de la lista 
#y la coloca en la cola, cuando finalizan todos los procesos 
#de realizar el calculo se realiza la suma acumualda de todos  
#los valores calculadas por cada una de los procesos.
